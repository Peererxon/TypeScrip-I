...
{ 
	...
	rieles()
	{
     ...
     pintar(contexto:CanvasRenderingContext2D,X:number,Y:number,figura:number,L:number,R:number)
     {
        ...
        if (figura==1){ 
			...
			color = "rgb("+Math.random()*255+","+Math.random()*255+","+Math.random()*255+")";contexto.fillStyle = color;
			...
			contexto.fillStyle = color;
			contexto.fillRect(31,420,750,30); contexto.fill(); contexto.stroke(); // Union de vagones
			var vagoni = 51; // pto Inicial (vagones)
			for (var i = 0; i < 3; i++) {
								color = "rgb("+Math.random()*255+","+Math.random()*255+","+Math.random()*255+")";
				                contexto.fillStyle = color;
								contexto.fillRect(vagoni,280,180,200); contexto.fill(); contexto.stroke();  
								vagoni+= 230; //Distancia entre vagones
								
			
			}
			color = "rgb("+Math.random()*255+","+Math.random()*255+","+Math.random()*255+")";contexto.fillStyle = color;
			contexto.fillRect(780,130,250,350); contexto.fill(); contexto.stroke(); // Tren carro

			contexto.fillStyle="orange";
			contexto.fillRect(730,60,350,70); contexto.fill(); contexto.stroke(); // Tren carro techo

			color = "rgb("+Math.random()*255+","+Math.random()*255+","+Math.random()*255+")";contexto.fillStyle = color;
			contexto.fillRect(830,190,150,150); contexto.fill(); contexto.stroke(); // Tren Ventana

			color = "rgb("+Math.random()*255+","+Math.random()*255+","+Math.random()*255+")"; contexto.fillStyle = color;
			contexto.fillRect(1030,280,200,200); contexto.fill(); contexto.stroke(); // Tren motor

			color = "rgb("+Math.random()*255+","+Math.random()*255+","+Math.random()*255+")"; contexto.fillStyle = color;
			contexto.fillRect(1140,205,58,75); contexto.fill(); contexto.stroke(); // Tren motor chimenea

			color = "rgb("+Math.random()*255+","+Math.random()*255+","+Math.random()*255+")"; contexto.fillStyle = color;
			contexto.fillRect(1105,125,125,80); contexto.fill(); contexto.stroke(); // fumarola
